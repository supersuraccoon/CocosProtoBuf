...
enum RoleType {
  ...
  BOWMAN = 1,
  MAGICIAN = 2,
  RoleType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  RoleType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
template <> struct is_proto_enum< ::game::enumeration::RoleType> : ::google::protobuf::internal::true_type {};
template <>
